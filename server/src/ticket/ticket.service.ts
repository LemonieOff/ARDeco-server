...
export class TicketService {
    ...
    async update(id: number, data: QueryPartialEntity<Ticket>): Promise<Ticket> {
    ...
    async delete(id: number): Promise<any> {
        ...
        return this.TicketRepository.createQueryBuilder('gallery').delete().from(Ticket).where("id = id", {id: id}).execute()
    }
}
