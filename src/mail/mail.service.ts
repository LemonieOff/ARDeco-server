...
export class MailService {
    public async sendWelcomeAndVerification(email: string, token: string) {
...
Si le lien ne fonctionne pas, veuillez le copier-coller dans votre navigateur.</p></body>`;
    ...
    public async sendPasswordChanged(email: string, first_name: string) {
...
Nous vous souhaitons une bonne journée, et à bientôt sur ARDeco !</p></body>`;
    ...
    public async sendInvoice(email: string, invoice_id: number) {
...
Nous vous souhaitons une excellente journée, et à bientôt sur ARDeco !</p></body>`;
    ...
    private sendEmail(
        ...
        from: EmailSender = ARDeco_sender
